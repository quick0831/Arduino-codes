...
Private Sub Winsock1_DataArrival(ByVal bytesTotal As Long)
    ...
    If dataType = "g:" Then
        ...
        If tmpindex < 9 Then        '下棋子
            ...
            '顯示結果
            xo = 1 - xo
        ElseIf tempindex = 99 Then  '對方贏了
            Text2.Text = "You Lost!!"
            go.Enabled = True
        ElseIf tempindex = 22 Then  '對方按重玩
...
Private Sub Image1_Click(Index As Integer)
    If TF(Index) <> 2 Or isConnect = False Or Abs(ListenSide) - xo <> 0 Then Exit Sub
