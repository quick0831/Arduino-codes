...
Text3.Text = Winsock1.LocalIP '"目前IP:" & Winsock1.LocalIP & vbCrLf
Text4.Text = lport 'Text2.Text & "目前Port:" & lport & vbCrLf
...
Private Sub Winsock1_DataArrival(ByVal bytesTotal As Long)
    Winsock1.GetData tmpindex, vbInteger
    If tmpindex < 9 Then
        Image1(tmpindex).Picture = Image2(1).Picture
        TF(tmpindex) = 1
        Call whowin
        '顯示結果
        xo = 1 - xo
        Text2.Text = tmpindex & vbCrLf & Text2.Text
    Else
        MsgBox "You lost!!"
    End If
End Sub
...
Private Sub Image1_Click(Index As Integer)
    ...
    Call whowin '顯示結果
    xo = 1 - xo
     Winsock1.SendData Index '把資料送出去
